...
contract CosmicLabs is ERC721Enumerable, IERC721Receiver, Ownable {
   ...
   //genesis mint free - 1000 - 5 per wallet - 5 max tx
   //ducks - 0.05 - 8000 - 40 per wallet - 40 max tx
   //airdrop to communityWallet 250 after mainsale starts
   
   //genesis free mint for ducks
   //5 genesis = 5 ducks
   ...
   address communityWallet = 0x2aCc47fd72b87d02e8E57051688e5db44CB04C69;
	...
	function communityDuckMint() public onlyOwner
	{
